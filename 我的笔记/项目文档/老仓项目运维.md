...
1.载体代码在排查后发现，载体代码中有一条脏数据录入到es库中，程序在读取es数据转换时报错，解决方法是将es的脏数据手动修改正确，然后重新同步；

2.relation代码中是在访问reids函数时获取时间异常，解决方法是修改utils.py的代码逻辑；![1763106406509](image/老仓项目运维/1763106406509.png)

3.并且在排查时发现以上两个azkaban项目有索引状态异常报错的情况，已经反馈运维对ES集群机型修复；
...
![1763361100552](image/老仓项目运维/1763361100552.png)

publish_year >=2024  and  update_time >= '{dt}'
